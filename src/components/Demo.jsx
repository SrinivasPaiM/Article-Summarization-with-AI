...
const Demo = () => {
  ...
  const handleSubmit = async (e) => { 
    ...
    if (data?.summary){
      const newArticles = { ...article, summary: data.summary };
  ...
  return (
    <section className="mt-16 w-full max-w-xl">
          ...
          {allArticles.map((item, index) => (
            ...
            >
              <div className="copy_btn" onClick={() => handleCopy(item.url)}>
                ...
                alt="copyIcon" className="w-[40%] h-[40%] object-contain"/>
              </div>
      ...
      { /* displayresults */}
      <div className="my-10 max-w-full flex justify-center justify-items-center">
        {isFetching ? (
